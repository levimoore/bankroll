...
define('bankroll-v1/models/player', ['exports', 'ember-data'], function (exports, DS) {
	...
	exports['default'] = DS['default'].Model.extend({
		...
		college: DS['default'].attr('string'),
		squad: DS['default'].attr('string'),
		team: DS['default'].attr("string"),
		nflteam: DS['default'].belongsTo('nflteam')  
	});
...
define('bankroll-v1/routes/players/index', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          dom.insertBoundary(fragment, 0);
          content(env, morph0, context, "player.firstName");
          content(env, morph1, context, "player.lastName");
          return fragment;
        }
      };
    }());
    return {
      ...
      build: function build(dom) {
        ...
        var el2 = dom.createTextNode("THis");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
      ...
      render: function render(context, env, contextualElement) {
        ...
        dom.insertBoundary(fragment, null);
        block(env, morph0, context, "each", [get(env, context, "arrangedContent")], {"keyword": "player"}, child0, null);
        return fragment;
      }
    };
  }()));
...
define('bankroll-v1/templates/players/index', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("h2");
        var el2 = dom.createTextNode(" Where are you?");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
...
define('bankroll-v1/tests/unit/routes/players/index-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:players/index', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
